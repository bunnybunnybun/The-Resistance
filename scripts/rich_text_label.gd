...
@onready var dialogs = {
	...
	7: "Great! Let's test it now, by pinging a website to make sure our wifi is working. Ping the website of your choice with 'ping <website_name>'.\n          \nYou may notice that it is now continually pinging the site over and over, with no signs of stopping. Whenever a program continues running like this, and you want to stop it, you can use the keybind 'ctrl + c' to kill it."
}
func _ready() -> void:
